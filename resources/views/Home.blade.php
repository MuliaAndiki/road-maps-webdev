    ...
    <div class="bg-slate-900 h-screen w-screen">
        ...
        <div class="bg-white " id='container-guides'>
            ...
            <div class="flex justify-center items-center">
                <p class="font-light">roadmap.sh is the 7th most starred project on GitHub and is visited by hundreds of
                    thousands of developers every month.</p>
            </div>
                    ...
                    <div class="border-r-1">
                        <div class="flex justify-center items-center">
                            <div>
                                ...
                                <div
                                    class="flex justify-center items-center hover:bg-slate-800 duration-[1s] rounded-lg hover:text-white">
                                    <div
                                        class="border-2 w-[13vw] h-[7vh] rounded-lg flex flex-col justify-center items-center">
