      ...
      <div class="flex-col">
        <div class="w-[40vw] border-1 rounded-md p-[1rem]">
          ...
          <div class="flex justify-start flex-col">
            <h1 class="font-bold text-[3rem]">FrontEnd</h1>
            <p class="font-light">Step by step guide to becoming a modern frontend developer in 2025</p>
          </div>
          <div class="flex justify-between">
            <div class="flex gap-x-2">
              <a href="#">
        ...
        <div class="flex justify-between border-2 rounded-md p-2">
          <div class="flex items-center">
            ...
            <h1>Apakah kamu Ready Menjadi WebDevelover?</h1>
          </div>
          <div class="">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="size-5">
              <path fill-rule="evenodd"
